...
Die Fläche unter der Kurve ist ein Maß für die Vorhersagekraft eines Modells, wobei ein perfektes Modell einen AUC-Wert von eins annimmt. Ein AUC-Wert von 0.5 hingegen besagt, dass das Modell dieselbe prädiktive Kraft besitzt, wie der Wurf einer fairen Münze.
...
\begin{figure}
\centering
\includegraphics[scale=0.5]{../rocNN1L.png}
\end{figure}
